...
use Simtabi\Image\AbstractFont;
use Simtabi\Image\AbstractShape;
use Simtabi\Image\Image;
use Simtabi\Image\ImageManager;
...
class Avatar
{
     ...
     * @return $this
     */
    public function setShape(string $shape = Avatar::SHAPE_SQUARE): self
    {
        $this->shape = $shape;
    ...
    public function toBase64()
    {
        ...
        $base64 = (string)$this->image->encode('data-url', 100);
